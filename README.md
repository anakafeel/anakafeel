...
| [![My Skills](https://skillicons.dev/icons?i=arch,linux,windows)](https://skillicons.dev) ![Fedora](https://img.shields.io/badge/Fedora-51A2DA?style=flat&logo=fedora&logoColor=white) ![CachyOS](https://img.shields.io/badge/CachyOS-000000?style=flat&logo=linux&logoColor=white) | [![My Skills](https://skillicons.dev/icons?i=mysql,firebase,django,postgres,supabase)](https://skillicons.dev) | [![My Skills](https://skillicons.dev/icons?i=wasm,threejs,docker,arduino,aws,linux,raspberrypi)](https://skillicons.dev) |

# <img src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Fedora_logo.svg" width="24" height="24"> Current Setup (Fedora 42 + Niri WM)

## Screenshots
| | |
|:---:|:---:|
| ![Screenshot 1](https://github.com/user-attachments/assets/7ae6874f-1a7b-4ed9-8fdb-d033329a457b) | ![Screenshot 2](https://github.com/user-attachments/assets/2d1d26eb-b6f1-4446-b74f-060b62f552ce) |
| ![Screenshot 3](https://github.com/user-attachments/assets/1d50fbc0-98d2-4084-ae09-5d3d22bd50a6) | ![Screenshot 4](https://github.com/user-attachments/assets/d9689099-f2c7-4a1c-a710-e58edb2521a2) |
| ![Screenshot 5](https://github.com/user-attachments/assets/4d13e165-4460-4408-8036-2aa1e1adee07) | ![Screenshot 6](https://github.com/user-attachments/assets/cf5b2e58-85e3-4f24-85d8-da0ba7f9d048) |
...
- **Shell:** [DankMaterialShell](https://github.com/avengemedia/dms)
- **Terminal:** [Alacritty](https://alacritty.org/) with JetBrainsMono Nerd Font
- **Editor:** [AstroNvim](https://astronvim.com/) with dynamic matugen colors
- **Dynamic Theming:** [matugen](https://github.com/InioX/matugen), bar, terminal, neovim, VS Code, and Spicetify all update on wallpaper change
...
# <a title="ptr1337, GPL &lt;http://www.gnu.org/licenses/gpl.html&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:CachyOS_Logo.svg"><img width="20" height="20" alt="CachyOS Logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/CachyOS_Logo.svg/64px-CachyOS_Logo.svg.png?20230130074653"></a> Previous Setup (CachyOS)
...
💻 Check out my caelestia dotfiles: [My Dotfiles Repo](https://github.com/anakafeel/dotfiles/tree/main/caelestia)

> Migrated to [CachyOS](https://cachyos.org/) from [vanilla Arch](https://archlinux.org/).
